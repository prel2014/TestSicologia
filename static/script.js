...
const app = new Vue({
    ...
    data:{
        ...
        dejar:[],
        preguntas:[
            {p:'1. ¿Le gusta abundancia de excitación y bullicio a su alrededor?',respuesta:'',valor:[],tipo:'E'},
            {p:'2. ¿Tiene a menudo un sentimiento de intranquilidad, como si quisiera algo, pero sin saber qué?',respuesta:'',valor:[],tipo:'N'},
            {p:'3. ¿Tiene casi siempre una contestación lista a la mano cuando se le habla?',respuesta:'',valor:[],tipo:'E'},
            {p:'4. ¿Se siente algunas veces feliz, algunas veces triste, sin una razón real?',respuesta:'',valor:[],tipo:'N'},
            {p:'5. ¿Permanece usualmente retraído (a) en fiestas y reuniones?',respuesta:'',valor:[],tipo:'E'},
            {p:'6. ¿Cuando era niño(a) ¿hacia siempre inmediatamente lo que le decían, sin refunfuñar?',respuesta:'',valor:[],tipo:'L'},
            {p:'7. ¿Se enfada o molesta a menudo?',respuesta:'',valor:[],tipo:'N'},
            {p:'8. Cuando lo(a) meten a una pelea  ¿Prefiere sacar los trapitos al aire de una vez por todas, en vez de   quedar callado(a) esperando que las cosas se calmen solas?',respuesta:'',valor:[],tipo:'E'},
            ...
            {p:'13. ¿Se catalogaría a si mismo(a) como despreocupado (a) o confiado a su buena suerte',respuesta:'',valor:[],tipo:'E'},
            ...
            {p:'21. ¿Se distrae (vaga su mente) a menudo cuando trata de prestar atención a algo?',respuesta:'',valor:[],tipo:'N'},
            ...
            {p:'28. ¿Cuándo se fastidia ¿necesita algún(a) amigo(a) para hablar sobre ello?',respuesta:'',valor:[],tipo:'N'},
            {p:'29. ¿Le molesta vender cosas o pedir dinero a la gente para alguna buena causa?',respuesta:'',valor:[],tipo:'E'},
            ...
            {p:'32. ¿Le gusta más quedarse en casa, que ir a una fiesta aburrida?',respuesta:'',valor:[],tipo:'E'},
            {p:'33. ¿Se pone a menudo tan inquieto(a) que no puede permanecer sentado(a) durante mucho rato en una silla?',respuesta:'',valor:[],tipo:'N'},
            ...
            {p:'36. ¿Contesta siempre una carta personal, tan pronto como puede, después de haberla leído?',respuesta:'',valor:[],tipo:'L'},
            {p:'37. ¿Hace usted usualmente las cosas mejor resolviéndolas solo(a) que hablando a otra persona sobre ello?',respuesta:'',valor:[],tipo:'E'},
            {p:'38. ¿Le falta frecuentemente aire, sin haber hecho un trabajo pesado?',respuesta:'',valor:[],tipo:'N'},
            {p:'39. ¿Es usted generalmente una persona tolerante, que no se molesta si las cosas no están perfectas?',respuesta:'',valor:[],tipo:'E'},
            ...
            {p:'42. ¿Deja algunas veces para mañana. Lo que debería hacer hoy día?',respuesta:'',valor:[],tipo:'L'},
            {p:'43. ¿Se pone nervioso(a) en lugares tales como ascensores, trenes o túneles?',respuesta:'',valor:[],tipo:'N'},
            {p:'44. Cuando hace nuevos amigos(as) ¿Es usted usualmente quien inicia la relación o invita a que se produzca?',respuesta:'',valor:[],tipo:'E'},
            {p:'45. ¿Sufre fuertes dolores de cabeza?',respuesta:'',valor:[],tipo:'N'},
            {p:'46. ¿Siente generalmente que las cosas se arreglaran por si solas y que terminaran bien de algún modo?',respuesta:'',valor:[],tipo:'E'},
            {p:'47. ¿Le cuesta trabajo coger el sueño al acostarse en las noches?',respuesta:'',valor:[],tipo:'N'},
    ...
    methods:{
        rellenar(){
            for(i=1;i<=50;i++)this.grupo.push(i);
        },
        siguienteLote(){
            this.dejar.splice(0)
            permiso=false
